...
import waykoutImg from '../assets/images/waykout-preview.png?format=webp&w=1200';
import helixImg from '../assets/images/helix-preview.png?format=webp&w=1200';
          ...
          <div className="project-image large project-helix">
            ...
            <div className="project-helix-content">
              ...
              <div className="project-helix-media">
                <img src={helixImg} alt="Helix Design System Preview" className="helix-preview-image" />
              </div>
            </div>
          </div>
        </div>
