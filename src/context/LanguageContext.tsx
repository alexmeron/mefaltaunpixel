...
export const LanguageProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const translations: any = {
    es: {
      ...
      waykout_desc: "Un marketplace de experiencias tradicionales y turismo sostenible diseñado para potenciar la economía de las comunidades locales y revitalizar la cultura de la región.",
      helix_title: "Helix Design System",
      helix_desc: "Un sistema de diseño completo y robusto creado para unificar la experiencia de marca, acelerar los flujos de diseño y desarrollo, y garantizar la consistencia en múltiples productos digitales.",
      ...
      soul_placeholder: "Pregunta cualquier cosa sobre Álex",
      soul_greeting: "Hola. Soy Soul. ¿Qué quieres saber sobre Álex?",
      soul_suggestion_about: "Sobre Álex",
      ...
      seo_project_suffix: " | Proyecto de Diseño de Producto por Álex Salmerón",
      // Lab Section ES
      ...
      seo_articles_title: "Artículos | Álex Salmerón - Product Designer",
    ...
    en: {
      ...
      waykout_title: "Waykout",
      waykout_desc: "A marketplace for traditional experiences and sustainable tourism designed to boost the local community economy and revitalize the region's culture.",
      helix_title: "Helix Design System",
      helix_desc: "A complete and robust design system built to unify brand experience, accelerate design and development workflows, and guarantee consistency across multiple digital products.",
