...
export const LanguageProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const translations: any = {
    es: {
      ...
      hero_subtitle: "Diseñador de Producto con más de 10 años de experiencia. Especializado en Sistemas de Diseño que permiten a equipos y empresas escalar con velocidad y consistencia.",
      skills_intro: "Mis habilidades, mi craft y mi forma de pensar el diseño.",
      ...
      seo_home_desc: "Portfolio de Alex Salmerón, Diseñador de Producto Senior con +10 años de experiencia. Especialista en Sistemas de Diseño, DesignOps y creación de productos digitales escalables en Figma.",
    ...
    en: {
      ...
      nav_about: "About",
      nav_work: "Work",
      nav_articles: "Articles (coming soon)",
      nav_resume: "Resume",
      ...
      skills_intro: "Showcase my skills, craft, and the way I think about design.",
      ...
      // SEO EN
      seo_home_title: "Alex Salmerón - Senior Product Designer",
      seo_home_desc: "Portfolio of Alex Salmerón, Senior Product Designer with 10+ years of experience. Specialist in Design Systems, DesignOps, and building scalable digital products in Figma.",
