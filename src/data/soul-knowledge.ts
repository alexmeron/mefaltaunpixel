...
export const SOUL_KNOWLEDGE: KnowledgeEntry[] = [
  ...
  },
  {
    ...
    responseEn: "Alex Salmerón is a Senior Product Designer with 10+ years of experience, specialized in Design Systems and Product Design. Currently at Cella Medical Solutions, he bridges the gap between design and engineering.",
    responseEs: "Alex Salmerón es un Senior Product Designer con más de 10 años de experiencia, especializado en Design Systems y Product Design. Actualmente en Cella Medical Solutions, actúa como puente entre diseño e ingeniería."
  },
  {
  ...
  },
  {
    ...
    responseEs: [
      ...
      "¡Jaja! Veo que Alex te ha contado los chistes buenos.",
...
export const DEFAULT_RESPONSE_EN = "I'm Soul, Alex's companion. I can tell you about his 10+ years of experience in Design Systems, his work at Cella or DisplayNote, or how to contact him.";
export const DEFAULT_RESPONSE_ES = "Soy Soul, la compañía de Alex. Puedo contarte sobre sus más de 10 años de experiencia en Design Systems, su trabajo en Cella o DisplayNote, o cómo contactar con él.";
